...
author: "Group 1, Arjun Chidambaram, Edward Ang, Masahiro Abe, Killian Huang: xhuang1"
...
b.  Create a waffle chart for the `content_rating` variable in the `imdb` data from the homework 5 practice lab exam Problem 6.  Use 25 rows.  Then recreate the same graph, but use 50 rows.  Which version of the chart do you prefer?
